                  ...
                  <tr>
                    <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                      <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:14px;text-align:left;color:#000000;">
                        <b>Termín konania:</b> {{ $eventStartTime }}<br>
                        <b>Lektor:</b> {{ $lectorsFirstName }}<br>
                        <b>Miesto:</b> <a href="http://www.google.com/maps/place/{{ $eventLocation->latitude }},{{ $eventLocation->longitude }}">{{ $eventLocationName }}</a><br>
                      </div>
                    </td>
                  </tr>
                </table>
