                  ...
                  <tr>
                    <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                      <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:14px;text-align:left;color:#000000;">
                        <b>Pre zmenu hesla klikni na:</b> <a href="https://space.nexteria.sk/password/reset/{{ $token }}">https://space.nexteria.sk/password/reset/{{ $token }}</a><br>
                      </div>
                    </td>
                  </tr>
                </table>
                ...
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                  <tr>
                    <td align="left" style="font-size:0px;padding:10px 25px;padding-top:0px;padding-bottom:0px;word-break:break-word;">
                      <div style="font-family:Helvetica,Arial,sans-serif;font-size:10px;line-height:12px;text-align:left;color:#000000;"> NLA tím </div>
                    </td>
                  </tr>
                </table>
              </div>
                ...
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="background-color:#fcc133;vertical-align:top;" width="100%">
                  <tr>
                    <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                      <div style="font-family:Helvetica,Arial,sans-serif;font-size:10px;line-height:12px;text-align:center;color:#ffffff;"> Copyright © 2018 Nexteria, All rights reserved. </div>
                    </td>
                  </tr>
                </table>
              </div>
