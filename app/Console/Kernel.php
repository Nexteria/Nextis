...
class Kernel extends ConsoleKernel
{
    ...
    protected $commands = [
        ...
        Commands\SendFeedbackFormNotification::class,
    ...
    protected function schedule(Schedule $schedule)
    {
        ...
        $schedule->command('autogenerate:feedbackFormNotification')->dailyAt('10:30');
        $schedule->command('autogenerate:feedbackFormRemainder')->dailyAt('01:00');
        $schedule->command('autogenerate:feedbackStatsMail')->dailyAt('23:59');
    }
}
